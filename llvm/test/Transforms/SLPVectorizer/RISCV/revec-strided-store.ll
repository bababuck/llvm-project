...
; RUN: opt -mtriple=riscv64 -mcpu=sifive-p870 -passes=slp-vectorizer -S -slp-revec -slp-enable-strided-stores -slp-threshold=-100 %s | FileCheck %s
...
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.v2i64.p0.i64(<2 x i64> [[TMP2]], ptr align 2 [[OUT:%.*]], i64 16, <2 x i1> splat (i1 true), i32 2)
; CHECK-NEXT:    ret void
;
entry:
...
; CHECK-NEXT:    call void @llvm.experimental.vp.strided.store.v2i64.p0.i64(<2 x i64> zeroinitializer, ptr align 2 null, i64 32, <2 x i1> splat (i1 true), i32 2)
; CHECK-NEXT:    ret void
;
