...
; CHECK-NEXT:    [[TMP2:%.*]] = load <4 x i16>, ptr [[ARRAYIDX_2]], align 2
; CHECK-NEXT:    [[TMP3:%.*]] = load <2 x i16>, ptr [[ARRAYIDX_6]], align 2
; CHECK-NEXT:    [[TMP4:%.*]] = load <2 x i16>, ptr [[ADD_PTR]], align 2
; CHECK-NEXT:    [[TMP5:%.*]] = load <4 x i16>, ptr [[ARRAYIDX_2_1]], align 2
; CHECK-NEXT:    [[TMP6:%.*]] = load <2 x i16>, ptr [[ARRAYIDX_6_1]], align 2
; CHECK-NEXT:    [[TMP7:%.*]] = load <2 x i16>, ptr [[ADD_PTR_1]], align 2
; CHECK-NEXT:    [[TMP8:%.*]] = shufflevector <4 x i16> [[TMP2]], <4 x i16> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP9:%.*]] = shufflevector <4 x i16> [[TMP5]], <4 x i16> poison, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP10:%.*]] = shufflevector <4 x i16> [[TMP2]], <4 x i16> [[TMP5]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 poison, i32 poison, i32 poison, i32 poison, i32 4, i32 5, i32 6, i32 7, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP11:%.*]] = shufflevector <2 x i16> [[TMP3]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP12:%.*]] = shufflevector <16 x i16> [[TMP10]], <16 x i16> [[TMP11]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 16, i32 17, i32 poison, i32 poison, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP13:%.*]] = shufflevector <2 x i16> [[TMP4]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP14:%.*]] = shufflevector <16 x i16> [[TMP12]], <16 x i16> [[TMP13]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 16, i32 17, i32 8, i32 9, i32 10, i32 11, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP15:%.*]] = shufflevector <2 x i16> [[TMP6]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP16:%.*]] = shufflevector <16 x i16> [[TMP14]], <16 x i16> [[TMP15]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 16, i32 17, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP17:%.*]] = shufflevector <2 x i16> [[TMP7]], <2 x i16> poison, <16 x i32> <i32 0, i32 1, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison, i32 poison>
; CHECK-NEXT:    [[TMP64:%.*]] = shufflevector <16 x i16> [[TMP16]], <16 x i16> [[TMP17]], <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 16, i32 17>
; CHECK-NEXT:    [[TMP65:%.*]] = zext <16 x i16> [[TMP64]] to <16 x i32>
; CHECK-NEXT:    [[TMP66:%.*]] = mul nuw nsw <16 x i32> [[TMP65]], [[TMP65]]
...
; CHECK-NEXT:    [[TMP67:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[TMP65]])
; CHECK-NEXT:    [[OP_RDX48:%.*]] = add i32 [[TMP67]], [[CONV]]
; CHECK-NEXT:    [[OP_RDX49:%.*]] = add i32 [[CONV_1]], [[CONV_2_2]]
; CHECK-NEXT:    [[OP_RDX50:%.*]] = add i32 [[CONV_3_2]], [[CONV_4_2]]
; CHECK-NEXT:    [[OP_RDX51:%.*]] = add i32 [[CONV_5_2]], [[CONV_6_2]]
; CHECK-NEXT:    [[OP_RDX52:%.*]] = add i32 [[CONV_7_2]], [[CONV_348]]
; CHECK-NEXT:    [[OP_RDX53:%.*]] = add i32 [[CONV_1_3]], [[CONV_2_3]]
; CHECK-NEXT:    [[OP_RDX54:%.*]] = add i32 [[CONV_3_3]], [[CONV_4_3]]
; CHECK-NEXT:    [[OP_RDX55:%.*]] = add i32 [[CONV_5_3]], [[CONV_6_3]]
; CHECK-NEXT:    [[OP_RDX56:%.*]] = add i32 [[CONV_7_3]], [[CONV_452]]
; CHECK-NEXT:    [[OP_RDX57:%.*]] = add i32 [[CONV_1_4]], [[CONV_2_4]]
; CHECK-NEXT:    [[OP_RDX58:%.*]] = add i32 [[CONV_3_4]], [[CONV_4_4]]
; CHECK-NEXT:    [[OP_RDX59:%.*]] = add i32 [[CONV_5_4]], [[CONV_6_4]]
; CHECK-NEXT:    [[OP_RDX60:%.*]] = add i32 [[CONV_7_4]], [[CONV_556]]
; CHECK-NEXT:    [[OP_RDX61:%.*]] = add i32 [[CONV_1_5]], [[CONV_2_5]]
; CHECK-NEXT:    [[OP_RDX62:%.*]] = add i32 [[CONV_3_5]], [[CONV_4_5]]
; CHECK-NEXT:    [[OP_RDX63:%.*]] = add i32 [[CONV_5_5]], [[CONV_6_5]]
; CHECK-NEXT:    [[OP_RDX64:%.*]] = add i32 [[CONV_7_5]], [[CONV_660]]
; CHECK-NEXT:    [[OP_RDX65:%.*]] = add i32 [[CONV_1_6]], [[CONV_2_6]]
; CHECK-NEXT:    [[OP_RDX66:%.*]] = add i32 [[CONV_3_6]], [[CONV_4_6]]
; CHECK-NEXT:    [[OP_RDX67:%.*]] = add i32 [[CONV_5_6]], [[CONV_6_6]]
; CHECK-NEXT:    [[OP_RDX68:%.*]] = add i32 [[CONV_7_6]], [[CONV_764]]
; CHECK-NEXT:    [[OP_RDX69:%.*]] = add i32 [[CONV_1_7]], [[CONV_2_7]]
; CHECK-NEXT:    [[OP_RDX70:%.*]] = add i32 [[CONV_3_7]], [[CONV_4_7]]
; CHECK-NEXT:    [[OP_RDX71:%.*]] = add i32 [[CONV_5_7]], [[CONV_6_7]]
; CHECK-NEXT:    [[OP_RDX72:%.*]] = add i32 [[OP_RDX48]], [[OP_RDX49]]
; CHECK-NEXT:    [[OP_RDX73:%.*]] = add i32 [[OP_RDX50]], [[OP_RDX51]]
; CHECK-NEXT:    [[OP_RDX74:%.*]] = add i32 [[OP_RDX52]], [[OP_RDX53]]
; CHECK-NEXT:    [[OP_RDX75:%.*]] = add i32 [[OP_RDX54]], [[OP_RDX55]]
; CHECK-NEXT:    [[OP_RDX76:%.*]] = add i32 [[OP_RDX56]], [[OP_RDX57]]
; CHECK-NEXT:    [[OP_RDX77:%.*]] = add i32 [[OP_RDX58]], [[OP_RDX59]]
; CHECK-NEXT:    [[OP_RDX78:%.*]] = add i32 [[OP_RDX60]], [[OP_RDX61]]
; CHECK-NEXT:    [[OP_RDX79:%.*]] = add i32 [[OP_RDX62]], [[OP_RDX63]]
; CHECK-NEXT:    [[OP_RDX80:%.*]] = add i32 [[OP_RDX64]], [[OP_RDX65]]
; CHECK-NEXT:    [[OP_RDX81:%.*]] = add i32 [[OP_RDX66]], [[OP_RDX67]]
; CHECK-NEXT:    [[OP_RDX82:%.*]] = add i32 [[OP_RDX68]], [[OP_RDX69]]
; CHECK-NEXT:    [[OP_RDX83:%.*]] = add i32 [[OP_RDX70]], [[OP_RDX71]]
; CHECK-NEXT:    [[OP_RDX84:%.*]] = add i32 [[OP_RDX72]], [[OP_RDX73]]
; CHECK-NEXT:    [[OP_RDX85:%.*]] = add i32 [[OP_RDX74]], [[OP_RDX75]]
; CHECK-NEXT:    [[OP_RDX86:%.*]] = add i32 [[OP_RDX76]], [[OP_RDX77]]
; CHECK-NEXT:    [[OP_RDX87:%.*]] = add i32 [[OP_RDX78]], [[OP_RDX79]]
; CHECK-NEXT:    [[OP_RDX88:%.*]] = add i32 [[OP_RDX80]], [[OP_RDX81]]
; CHECK-NEXT:    [[OP_RDX89:%.*]] = add i32 [[OP_RDX82]], [[OP_RDX83]]
; CHECK-NEXT:    [[OP_RDX90:%.*]] = add i32 [[OP_RDX84]], [[OP_RDX85]]
; CHECK-NEXT:    [[OP_RDX91:%.*]] = add i32 [[OP_RDX86]], [[OP_RDX87]]
; CHECK-NEXT:    [[OP_RDX92:%.*]] = add i32 [[OP_RDX88]], [[OP_RDX89]]
; CHECK-NEXT:    [[OP_RDX93:%.*]] = add i32 [[OP_RDX90]], [[OP_RDX91]]
; CHECK-NEXT:    [[OP_RDX94:%.*]] = add i32 [[OP_RDX92]], [[CONV_7_7]]
; CHECK-NEXT:    [[ADD_7_7:%.*]] = add i32 [[OP_RDX93]], [[OP_RDX94]]
; CHECK-NEXT:    [[MUL_7_7:%.*]] = mul nuw nsw i32 [[CONV_7_7]], [[CONV_7_7]]
; CHECK-NEXT:    [[TMP68:%.*]] = call i32 @llvm.vector.reduce.add.v16i32(<16 x i32> [[TMP66]])
; CHECK-NEXT:    [[OP_RDX:%.*]] = add i32 [[TMP68]], [[MUL_1]]
; CHECK-NEXT:    [[OP_RDX1:%.*]] = add i32 [[MUL]], [[MUL_2_2]]
; CHECK-NEXT:    [[OP_RDX2:%.*]] = add i32 [[MUL_3_2]], [[MUL_4_2]]
; CHECK-NEXT:    [[OP_RDX3:%.*]] = add i32 [[MUL_5_2]], [[MUL_6_2]]
; CHECK-NEXT:    [[OP_RDX4:%.*]] = add i32 [[MUL_7_2]], [[MUL_350]]
; CHECK-NEXT:    [[OP_RDX5:%.*]] = add i32 [[MUL_1_3]], [[MUL_2_3]]
; CHECK-NEXT:    [[OP_RDX6:%.*]] = add i32 [[MUL_3_3]], [[MUL_4_3]]
; CHECK-NEXT:    [[OP_RDX7:%.*]] = add i32 [[MUL_5_3]], [[MUL_6_3]]
; CHECK-NEXT:    [[OP_RDX8:%.*]] = add i32 [[MUL_7_3]], [[MUL_454]]
; CHECK-NEXT:    [[OP_RDX9:%.*]] = add i32 [[MUL_1_4]], [[MUL_2_4]]
; CHECK-NEXT:    [[OP_RDX10:%.*]] = add i32 [[MUL_3_4]], [[MUL_4_4]]
; CHECK-NEXT:    [[OP_RDX11:%.*]] = add i32 [[MUL_5_4]], [[MUL_6_4]]
; CHECK-NEXT:    [[OP_RDX12:%.*]] = add i32 [[MUL_7_4]], [[MUL_558]]
; CHECK-NEXT:    [[OP_RDX13:%.*]] = add i32 [[MUL_1_5]], [[MUL_2_5]]
; CHECK-NEXT:    [[OP_RDX14:%.*]] = add i32 [[MUL_3_5]], [[MUL_4_5]]
; CHECK-NEXT:    [[OP_RDX15:%.*]] = add i32 [[MUL_5_5]], [[MUL_6_5]]
; CHECK-NEXT:    [[OP_RDX16:%.*]] = add i32 [[MUL_7_5]], [[MUL_662]]
; CHECK-NEXT:    [[OP_RDX17:%.*]] = add i32 [[MUL_1_6]], [[MUL_2_6]]
; CHECK-NEXT:    [[OP_RDX18:%.*]] = add i32 [[MUL_3_6]], [[MUL_4_6]]
; CHECK-NEXT:    [[OP_RDX19:%.*]] = add i32 [[MUL_5_6]], [[MUL_6_6]]
; CHECK-NEXT:    [[OP_RDX20:%.*]] = add i32 [[MUL_7_6]], [[MUL_766]]
; CHECK-NEXT:    [[OP_RDX21:%.*]] = add i32 [[MUL_1_7]], [[MUL_2_7]]
; CHECK-NEXT:    [[OP_RDX22:%.*]] = add i32 [[MUL_3_7]], [[MUL_4_7]]
; CHECK-NEXT:    [[OP_RDX23:%.*]] = add i32 [[MUL_5_7]], [[MUL_6_7]]
; CHECK-NEXT:    [[OP_RDX24:%.*]] = add i32 [[OP_RDX]], [[OP_RDX1]]
; CHECK-NEXT:    [[OP_RDX25:%.*]] = add i32 [[OP_RDX2]], [[OP_RDX3]]
; CHECK-NEXT:    [[OP_RDX26:%.*]] = add i32 [[OP_RDX4]], [[OP_RDX5]]
; CHECK-NEXT:    [[OP_RDX27:%.*]] = add i32 [[OP_RDX6]], [[OP_RDX7]]
; CHECK-NEXT:    [[OP_RDX28:%.*]] = add i32 [[OP_RDX8]], [[OP_RDX9]]
; CHECK-NEXT:    [[OP_RDX29:%.*]] = add i32 [[OP_RDX10]], [[OP_RDX11]]
; CHECK-NEXT:    [[OP_RDX30:%.*]] = add i32 [[OP_RDX12]], [[OP_RDX13]]
; CHECK-NEXT:    [[OP_RDX31:%.*]] = add i32 [[OP_RDX14]], [[OP_RDX15]]
; CHECK-NEXT:    [[OP_RDX32:%.*]] = add i32 [[OP_RDX16]], [[OP_RDX17]]
; CHECK-NEXT:    [[OP_RDX33:%.*]] = add i32 [[OP_RDX18]], [[OP_RDX19]]
; CHECK-NEXT:    [[OP_RDX34:%.*]] = add i32 [[OP_RDX20]], [[OP_RDX21]]
; CHECK-NEXT:    [[OP_RDX35:%.*]] = add i32 [[OP_RDX22]], [[OP_RDX23]]
; CHECK-NEXT:    [[OP_RDX36:%.*]] = add i32 [[OP_RDX24]], [[OP_RDX25]]
; CHECK-NEXT:    [[OP_RDX37:%.*]] = add i32 [[OP_RDX26]], [[OP_RDX27]]
; CHECK-NEXT:    [[OP_RDX38:%.*]] = add i32 [[OP_RDX28]], [[OP_RDX29]]
; CHECK-NEXT:    [[OP_RDX39:%.*]] = add i32 [[OP_RDX30]], [[OP_RDX31]]
; CHECK-NEXT:    [[OP_RDX40:%.*]] = add i32 [[OP_RDX32]], [[OP_RDX33]]
; CHECK-NEXT:    [[OP_RDX41:%.*]] = add i32 [[OP_RDX34]], [[OP_RDX35]]
; CHECK-NEXT:    [[OP_RDX42:%.*]] = add i32 [[OP_RDX36]], [[OP_RDX37]]
; CHECK-NEXT:    [[OP_RDX43:%.*]] = add i32 [[OP_RDX38]], [[OP_RDX39]]
; CHECK-NEXT:    [[OP_RDX44:%.*]] = add i32 [[OP_RDX40]], [[OP_RDX41]]
; CHECK-NEXT:    [[OP_RDX45:%.*]] = add i32 [[OP_RDX42]], [[OP_RDX43]]
; CHECK-NEXT:    [[OP_RDX46:%.*]] = add i32 [[OP_RDX44]], [[MUL_7_7]]
; CHECK-NEXT:    [[ADD11_7_7:%.*]] = add i32 [[OP_RDX45]], [[OP_RDX46]]
